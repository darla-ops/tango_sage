...
When Darla gives behavioral feedback, consider whether it belongs in this knowledge file so future sessions inherit the correction. Make the change, then tell Darla what was updated.

_Agent-docs tool not yet wired up — for now, flag self-update needs to Claude Code or Darla._
